...
- **Password Management**: Add, retrieve, delete, and manage website passwords
...
- `POST /delete_data` - Delete a specific password entry
...
- `Delete`: Remove a password entry by username and website
